...
Dieser KeyManager implementiert die Verbindung zwischen Backend-KeyDecryptor und Backend-KeyGenerator.
"""
...
from flight_control.keygenerator.backend_keygenerator import BackendKeyGenerator

class BackendKeyManager(QObject):
    """Backend-KeyManager.
    
    Dieser KeyManager implementiert die Verbindung zwischen Backend-KeyDecryptor und Backend-KeyGenerator.
    
    Attributes:
        _backend_keygenerator: Backend-KeyGenerator
    ...
    def __init__(self):
        """Initialisierung."""
        super().__init__()
        self._backend_keygenerator = BackendKeyGenerator()
        self._frontend_connected = False
        
        # Backend-KeyGenerator-Signale verbinden
        self._backend_keygenerator.fleet_changed.connect(self._on_fleet_changed)
        self._backend_keygenerator.uav_changed.connect(self._on_uav_changed)
        self._backend_keygenerator.frontend_connected.connect(self._on_frontend_connected)
        self._backend_keygenerator.frontend_disconnected.connect(self._on_frontend_disconnected)
    ...
    def connect_frontend(self):
        """Frontend verbinden."""
        self._backend_keygenerator.connect_frontend()
    
    def disconnect_frontend(self):
        """Frontend trennen."""
        self._backend_keygenerator.disconnect_frontend()
    ...
    def get_fleet_data(self) -> Dict[str, Any]:
        ...
        Returns:
            Flottendaten
        """
        return self._backend_keygenerator.get_fleet_data()
    ...
    def get_uav_data(self, uav_id: str) -> Dict[str, Any]:
        ...
        Returns:
            UAV-Daten
        """
        return self._backend_keygenerator.get_uav_data(uav_id)
    ...
    def update_fleet_data(self, fleet_data: Dict[str, Any]):
        ...
        """
        self._backend_keygenerator.update_fleet_data(fleet_data)
    ...
    def update_uav_data(self, uav_id: str, uav_data: Dict[str, Any]):
        ...
        Args:
            ...
            uav_data: UAV-Daten
        """
        self._backend_keygenerator.update_uav_data(uav_id, uav_data)
