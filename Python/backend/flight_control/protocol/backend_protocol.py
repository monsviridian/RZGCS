...
Dieses Protocol implementiert die Verbindung zwischen Backend-Client und Backend-Transport.
"""
...
from flight_control.transport.backend_transport import BackendTransport

class BackendProtocol(QObject):
    """Backend-Protocol.
    
    Dieses Protocol implementiert die Verbindung zwischen Backend-Client und Backend-Transport.
    
    Attributes:
        _backend_transport: Backend-Transport
    ...
    def __init__(self):
        """Initialisierung."""
        super().__init__()
        self._backend_transport = BackendTransport()
        self._frontend_connected = False
        
        # Backend-Transport-Signale verbinden
        self._backend_transport.fleet_changed.connect(self._on_fleet_changed)
        self._backend_transport.uav_changed.connect(self._on_uav_changed)
        self._backend_transport.frontend_connected.connect(self._on_frontend_connected)
        self._backend_transport.frontend_disconnected.connect(self._on_frontend_disconnected)
    ...
    def connect_frontend(self):
        """Frontend verbinden."""
        self._backend_transport.connect_frontend()
    
    def disconnect_frontend(self):
        """Frontend trennen."""
        self._backend_transport.disconnect_frontend()
    ...
    def get_fleet_data(self) -> Dict[str, Any]:
        ...
        Returns:
            Flottendaten
        """
        return self._backend_transport.get_fleet_data()
    ...
    def get_uav_data(self, uav_id: str) -> Dict[str, Any]:
        ...
        Returns:
            UAV-Daten
        """
        return self._backend_transport.get_uav_data(uav_id)
    ...
    def update_fleet_data(self, fleet_data: Dict[str, Any]):
        ...
        """
        self._backend_transport.update_fleet_data(fleet_data)
    ...
    def update_uav_data(self, uav_id: str, uav_data: Dict[str, Any]):
        ...
        Args:
            ...
            uav_data: UAV-Daten
        """
        self._backend_transport.update_uav_data(uav_id, uav_data)
