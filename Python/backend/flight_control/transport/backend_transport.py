...
Dieser Transport implementiert die Verbindung zwischen Backend-Protocol und Backend-Network.
"""
...
from flight_control.network.backend_network import BackendNetwork

class BackendTransport(QObject):
    """Backend-Transport.
    
    Dieser Transport implementiert die Verbindung zwischen Backend-Protocol und Backend-Network.
    
    Attributes:
        _backend_network: Backend-Network
    ...
    def __init__(self):
        """Initialisierung."""
        super().__init__()
        self._backend_network = BackendNetwork()
        self._frontend_connected = False
        
        # Backend-Network-Signale verbinden
        self._backend_network.fleet_changed.connect(self._on_fleet_changed)
        self._backend_network.uav_changed.connect(self._on_uav_changed)
        self._backend_network.frontend_connected.connect(self._on_frontend_connected)
        self._backend_network.frontend_disconnected.connect(self._on_frontend_disconnected)
    ...
    def connect_frontend(self):
        """Frontend verbinden."""
        self._backend_network.connect_frontend()
    
    def disconnect_frontend(self):
        """Frontend trennen."""
        self._backend_network.disconnect_frontend()
    ...
    def get_fleet_data(self) -> Dict[str, Any]:
        ...
        Returns:
            Flottendaten
        """
        return self._backend_network.get_fleet_data()
    ...
    def get_uav_data(self, uav_id: str) -> Dict[str, Any]:
        ...
        Returns:
            UAV-Daten
        """
        return self._backend_network.get_uav_data(uav_id)
    ...
    def update_fleet_data(self, fleet_data: Dict[str, Any]):
        ...
        """
        self._backend_network.update_fleet_data(fleet_data)
    ...
    def update_uav_data(self, uav_id: str, uav_data: Dict[str, Any]):
        ...
        Args:
            ...
            uav_data: UAV-Daten
        """
        self._backend_network.update_uav_data(uav_id, uav_data)
