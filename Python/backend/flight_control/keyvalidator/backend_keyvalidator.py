"""Backend-KeyValidator.

Dieser KeyValidator implementiert die Verbindung zwischen Backend-KeyGenerator und Backend-KeyVerifier.
"""
...
from flight_control.keyverifier.backend_keyverifier import BackendKeyVerifier

class BackendKeyValidator(QObject):
    """Backend-KeyValidator.
    
    Dieser KeyValidator implementiert die Verbindung zwischen Backend-KeyGenerator und Backend-KeyVerifier.
    
    Attributes:
        _backend_keyverifier: Backend-KeyVerifier
    ...
    def __init__(self):
        """Initialisierung."""
        super().__init__()
        self._backend_keyverifier = BackendKeyVerifier()
        self._frontend_connected = False
        
        # Backend-KeyVerifier-Signale verbinden
        self._backend_keyverifier.fleet_changed.connect(self._on_fleet_changed)
        self._backend_keyverifier.uav_changed.connect(self._on_uav_changed)
        self._backend_keyverifier.frontend_connected.connect(self._on_frontend_connected)
        self._backend_keyverifier.frontend_disconnected.connect(self._on_frontend_disconnected)
    ...
    def connect_frontend(self):
        """Frontend verbinden."""
        self._backend_keyverifier.connect_frontend()
    
    def disconnect_frontend(self):
        """Frontend trennen."""
        self._backend_keyverifier.disconnect_frontend()
    ...
    def get_fleet_data(self) -> Dict[str, Any]:
        ...
        Returns:
            Flottendaten
        """
        return self._backend_keyverifier.get_fleet_data()
    ...
    def get_uav_data(self, uav_id: str) -> Dict[str, Any]:
        ...
        Returns:
            UAV-Daten
        """
        return self._backend_keyverifier.get_uav_data(uav_id)
    ...
    def update_fleet_data(self, fleet_data: Dict[str, Any]):
        ...
        """
        self._backend_keyverifier.update_fleet_data(fleet_data)
    ...
    def update_uav_data(self, uav_id: str, uav_data: Dict[str, Any]):
        ...
        Args:
            ...
            uav_data: UAV-Daten
        """
        self._backend_keyverifier.update_uav_data(uav_id, uav_data)
