...
Diese Encryption implementiert die Verbindung zwischen Backend-Security und Backend-Crypto.
"""
...
from flight_control.crypto.backend_crypto import BackendCrypto

class BackendEncryption(QObject):
    """Backend-Encryption.
    
    Diese Encryption implementiert die Verbindung zwischen Backend-Security und Backend-Crypto.
    
    Attributes:
        _backend_crypto: Backend-Crypto
    ...
    def __init__(self):
        """Initialisierung."""
        super().__init__()
        self._backend_crypto = BackendCrypto()
        self._frontend_connected = False
        
        # Backend-Crypto-Signale verbinden
        self._backend_crypto.fleet_changed.connect(self._on_fleet_changed)
        self._backend_crypto.uav_changed.connect(self._on_uav_changed)
        self._backend_crypto.frontend_connected.connect(self._on_frontend_connected)
        self._backend_crypto.frontend_disconnected.connect(self._on_frontend_disconnected)
    ...
    def connect_frontend(self):
        """Frontend verbinden."""
        self._backend_crypto.connect_frontend()
    
    def disconnect_frontend(self):
        """Frontend trennen."""
        self._backend_crypto.disconnect_frontend()
    ...
    def get_fleet_data(self) -> Dict[str, Any]:
        ...
        Returns:
            Flottendaten
        """
        return self._backend_crypto.get_fleet_data()
    ...
    def get_uav_data(self, uav_id: str) -> Dict[str, Any]:
        ...
        Returns:
            UAV-Daten
        """
        return self._backend_crypto.get_uav_data(uav_id)
    ...
    def update_fleet_data(self, fleet_data: Dict[str, Any]):
        ...
        """
        self._backend_crypto.update_fleet_data(fleet_data)
    ...
    def update_uav_data(self, uav_id: str, uav_data: Dict[str, Any]):
        ...
        Args:
            ...
            uav_data: UAV-Daten
        """
        self._backend_crypto.update_uav_data(uav_id, uav_data)
