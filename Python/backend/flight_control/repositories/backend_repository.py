...
Dieses Repository implementiert die Verbindung zwischen Backend-Model und Backend-Database.
"""
...
from flight_control.database.backend_database import BackendDatabase

class BackendRepository(QObject):
    """Backend-Repository.
    
    Dieses Repository implementiert die Verbindung zwischen Backend-Model und Backend-Database.
    
    Attributes:
        _backend_database: Backend-Database
    ...
    def __init__(self):
        ...
        # Backend-Database-Signale verbinden
        self._backend_database.fleet_changed.connect(self._on_fleet_changed)
        self._backend_database.uav_changed.connect(self._on_uav_changed)
        self._backend_database.frontend_connected.connect(self._on_frontend_connected)
        self._backend_database.frontend_disconnected.connect(self._on_frontend_disconnected)
    ...
    def connect_frontend(self):
        """Frontend verbinden."""
        self._backend_database.connect_frontend()
    
    def disconnect_frontend(self):
        """Frontend trennen."""
        self._backend_database.disconnect_frontend()
    ...
    def get_fleet_data(self) -> Dict[str, Any]:
        ...
        Returns:
            Flottendaten
        """
        return self._backend_database.get_fleet_data()
    ...
    def get_uav_data(self, uav_id: str) -> Dict[str, Any]:
        ...
        Returns:
            UAV-Daten
        """
        return self._backend_database.get_uav_data(uav_id)
    ...
    def update_fleet_data(self, fleet_data: Dict[str, Any]):
        ...
        """
        self._backend_database.update_fleet_data(fleet_data)
    ...
    def update_uav_data(self, uav_id: str, uav_data: Dict[str, Any]):
        ...
        Args:
            ...
            uav_data: UAV-Daten
        """
        self._backend_database.update_uav_data(uav_id, uav_data)
