...
Diese Key implementiert die Verbindung zwischen Backend-Crypto und Backend-KeyStore.
"""
...
from flight_control.keystore.backend_keystore import BackendKeyStore

class BackendKey(QObject):
    """Backend-Key.
    
    Diese Key implementiert die Verbindung zwischen Backend-Crypto und Backend-KeyStore.
    
    Attributes:
        _backend_keystore: Backend-KeyStore
    ...
    def __init__(self):
        """Initialisierung."""
        super().__init__()
        self._backend_keystore = BackendKeyStore()
        self._frontend_connected = False
        
        # Backend-KeyStore-Signale verbinden
        self._backend_keystore.fleet_changed.connect(self._on_fleet_changed)
        self._backend_keystore.uav_changed.connect(self._on_uav_changed)
        self._backend_keystore.frontend_connected.connect(self._on_frontend_connected)
        self._backend_keystore.frontend_disconnected.connect(self._on_frontend_disconnected)
    ...
    def connect_frontend(self):
        """Frontend verbinden."""
        self._backend_keystore.connect_frontend()
    
    def disconnect_frontend(self):
        """Frontend trennen."""
        self._backend_keystore.disconnect_frontend()
    ...
    def get_fleet_data(self) -> Dict[str, Any]:
        ...
        Returns:
            Flottendaten
        """
        return self._backend_keystore.get_fleet_data()
    ...
    def get_uav_data(self, uav_id: str) -> Dict[str, Any]:
        ...
        Returns:
            UAV-Daten
        """
        return self._backend_keystore.get_uav_data(uav_id)
    ...
    def update_fleet_data(self, fleet_data: Dict[str, Any]):
        ...
        """
        self._backend_keystore.update_fleet_data(fleet_data)
    ...
    def update_uav_data(self, uav_id: str, uav_data: Dict[str, Any]):
        ...
        Args:
            ...
            uav_data: UAV-Daten
        """
        self._backend_keystore.update_uav_data(uav_id, uav_data)
