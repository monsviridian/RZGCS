...
Dieser Service implementiert die Verbindung zwischen Frontend-Controller und Backend-Service.
"""
...
from flight_control.services.backend_service import BackendService

class FrontendService(QObject):
    """Frontend-Service.
    ...
    def __init__(self):
        ...
        # Backend-Service-Signale verbinden
        self._backend_service.fleet_changed.connect(self._on_fleet_changed)
        self._backend_service.uav_changed.connect(self._on_uav_changed)
        self._backend_service.frontend_connected.connect(self._on_frontend_connected)
        self._backend_service.frontend_disconnected.connect(self._on_frontend_disconnected)
    ...
    def connect_frontend(self):
        """Frontend verbinden."""
        self._backend_service.connect_frontend()
    
    def disconnect_frontend(self):
        """Frontend trennen."""
        self._backend_service.disconnect_frontend()
    ...
    def get_fleet_data(self) -> Dict[str, Any]:
        ...
        Returns:
            Flottendaten
        """
        return self._backend_service.get_fleet_data()
    ...
    def get_uav_data(self, uav_id: str) -> Dict[str, Any]:
        ...
        Returns:
            UAV-Daten
        """
        return self._backend_service.get_uav_data(uav_id)
    ...
    def update_fleet_data(self, fleet_data: Dict[str, Any]):
        ...
        """
        self._backend_service.update_fleet_data(fleet_data)
    ...
    def update_uav_data(self, uav_id: str, uav_data: Dict[str, Any]):
        ...
        Args:
            ...
            uav_data: UAV-Daten
        """
        self._backend_service.update_uav_data(uav_id, uav_data)
