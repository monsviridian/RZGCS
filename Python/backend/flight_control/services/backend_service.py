...
Dieser Service implementiert die Verbindung zwischen Frontend-Service und Backend-Controller.
"""
...
from flight_control.controllers.backend_controller import BackendController
...
class BackendService(QObject):
    ...
    Attributes:
        _backend_controller: Backend-Controller
    ...
    def __init__(self):
        ...
        # Backend-Controller-Signale verbinden
        self._backend_controller.fleet_changed.connect(self._on_fleet_changed)
        self._backend_controller.uav_changed.connect(self._on_uav_changed)
        self._backend_controller.frontend_connected.connect(self._on_frontend_connected)
        self._backend_controller.frontend_disconnected.connect(self._on_frontend_disconnected)
    ...
    def connect_frontend(self):
        """Frontend verbinden."""
        self._backend_controller.connect_frontend()
    
    def disconnect_frontend(self):
        """Frontend trennen."""
        self._backend_controller.disconnect_frontend()
    ...
    def get_fleet_data(self) -> Dict[str, Any]:
        ...
        Returns:
            Flottendaten
        """
        return self._backend_controller.get_fleet_data()
    ...
    def get_uav_data(self, uav_id: str) -> Dict[str, Any]:
        ...
        Returns:
            UAV-Daten
        """
        return self._backend_controller.get_uav_data(uav_id)
    ...
    def update_fleet_data(self, fleet_data: Dict[str, Any]):
        ...
        """
        self._backend_controller.update_fleet_data(fleet_data)
    ...
    def update_uav_data(self, uav_id: str, uav_data: Dict[str, Any]):
        ...
        Args:
            ...
            uav_data: UAV-Daten
        """
        self._backend_controller.update_uav_data(uav_id, uav_data)
