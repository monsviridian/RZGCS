...
Dieses Network implementiert die Verbindung zwischen Backend-Transport und Backend-Security.
"""
...
from flight_control.security.backend_security import BackendSecurity

class BackendNetwork(QObject):
    """Backend-Network.
    
    Dieses Network implementiert die Verbindung zwischen Backend-Transport und Backend-Security.
    
    Attributes:
        _backend_security: Backend-Security
    ...
    def __init__(self):
        """Initialisierung."""
        super().__init__()
        self._backend_security = BackendSecurity()
        self._frontend_connected = False
        
        # Backend-Security-Signale verbinden
        self._backend_security.fleet_changed.connect(self._on_fleet_changed)
        self._backend_security.uav_changed.connect(self._on_uav_changed)
        self._backend_security.frontend_connected.connect(self._on_frontend_connected)
        self._backend_security.frontend_disconnected.connect(self._on_frontend_disconnected)
    ...
    def connect_frontend(self):
        """Frontend verbinden."""
        self._backend_security.connect_frontend()
    
    def disconnect_frontend(self):
        """Frontend trennen."""
        self._backend_security.disconnect_frontend()
    ...
    def get_fleet_data(self) -> Dict[str, Any]:
        ...
        Returns:
            Flottendaten
        """
        return self._backend_security.get_fleet_data()
    ...
    def get_uav_data(self, uav_id: str) -> Dict[str, Any]:
        ...
        Returns:
            UAV-Daten
        """
        return self._backend_security.get_uav_data(uav_id)
    ...
    def update_fleet_data(self, fleet_data: Dict[str, Any]):
        ...
        """
        self._backend_security.update_fleet_data(fleet_data)
    ...
    def update_uav_data(self, uav_id: str, uav_data: Dict[str, Any]):
        ...
        Args:
            ...
            uav_data: UAV-Daten
        """
        self._backend_security.update_uav_data(uav_id, uav_data)
