...
Dieser KeySigner implementiert die Verbindung zwischen Backend-KeyVerifier und Backend-KeyEncryptor.
"""
...
from flight_control.keyencryptor.backend_keyencryptor import BackendKeyEncryptor

class BackendKeySigner(QObject):
    """Backend-KeySigner.
    
    Dieser KeySigner implementiert die Verbindung zwischen Backend-KeyVerifier und Backend-KeyEncryptor.
    
    Attributes:
        _backend_keyencryptor: Backend-KeyEncryptor
    ...
    def __init__(self):
        """Initialisierung."""
        super().__init__()
        self._backend_keyencryptor = BackendKeyEncryptor()
        self._frontend_connected = False
        
        # Backend-KeyEncryptor-Signale verbinden
        self._backend_keyencryptor.fleet_changed.connect(self._on_fleet_changed)
        self._backend_keyencryptor.uav_changed.connect(self._on_uav_changed)
        self._backend_keyencryptor.frontend_connected.connect(self._on_frontend_connected)
        self._backend_keyencryptor.frontend_disconnected.connect(self._on_frontend_disconnected)
    ...
    def connect_frontend(self):
        """Frontend verbinden."""
        self._backend_keyencryptor.connect_frontend()
    
    def disconnect_frontend(self):
        """Frontend trennen."""
        self._backend_keyencryptor.disconnect_frontend()
    ...
    def get_fleet_data(self) -> Dict[str, Any]:
        ...
        Returns:
            Flottendaten
        """
        return self._backend_keyencryptor.get_fleet_data()
    ...
    def get_uav_data(self, uav_id: str) -> Dict[str, Any]:
        ...
        Returns:
            UAV-Daten
        """
        return self._backend_keyencryptor.get_uav_data(uav_id)
    ...
    def update_fleet_data(self, fleet_data: Dict[str, Any]):
        ...
        """
        self._backend_keyencryptor.update_fleet_data(fleet_data)
    ...
    def update_uav_data(self, uav_id: str, uav_data: Dict[str, Any]):
        ...
        Args:
            ...
            uav_data: UAV-Daten
        """
        self._backend_keyencryptor.update_uav_data(uav_id, uav_data)
