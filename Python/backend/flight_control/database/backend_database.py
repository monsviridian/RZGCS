...
Diese Database implementiert die Verbindung zwischen Backend-Repository und Backend-API.
"""
...
from flight_control.api.backend_api import BackendAPI

class BackendDatabase(QObject):
    """Backend-Database.
    ...
    def __init__(self):
        ...
        # Backend-API-Signale verbinden
        self._backend_api.fleet_changed.connect(self._on_fleet_changed)
        self._backend_api.uav_changed.connect(self._on_uav_changed)
        self._backend_api.frontend_connected.connect(self._on_frontend_connected)
        self._backend_api.frontend_disconnected.connect(self._on_frontend_disconnected)
    ...
    def connect_frontend(self):
        """Frontend verbinden."""
        self._backend_api.connect_frontend()
    
    def disconnect_frontend(self):
        """Frontend trennen."""
        self._backend_api.disconnect_frontend()
    ...
    def get_fleet_data(self) -> Dict[str, Any]:
        ...
        Returns:
            Flottendaten
        """
        return self._backend_api.get_fleet_data()
    ...
    def get_uav_data(self, uav_id: str) -> Dict[str, Any]:
        ...
        Returns:
            UAV-Daten
        """
        return self._backend_api.get_uav_data(uav_id)
    ...
    def update_fleet_data(self, fleet_data: Dict[str, Any]):
        ...
        """
        self._backend_api.update_fleet_data(fleet_data)
    ...
    def update_uav_data(self, uav_id: str, uav_data: Dict[str, Any]):
        ...
        Args:
            ...
            uav_data: UAV-Daten
        """
        self._backend_api.update_uav_data(uav_id, uav_data)
