"""Backend-KeyGenerator.

Dieser KeyGenerator implementiert die Verbindung zwischen Backend-KeyManager und Backend-KeyValidator.
"""
...
from flight_control.keyvalidator.backend_keyvalidator import BackendKeyValidator

class BackendKeyGenerator(QObject):
    """Backend-KeyGenerator.
    
    Dieser KeyGenerator implementiert die Verbindung zwischen Backend-KeyManager und Backend-KeyValidator.
    
    Attributes:
        _backend_keyvalidator: Backend-KeyValidator
    ...
    def __init__(self):
        """Initialisierung."""
        super().__init__()
        self._backend_keyvalidator = BackendKeyValidator()
        self._frontend_connected = False
        
        # Backend-KeyValidator-Signale verbinden
        self._backend_keyvalidator.fleet_changed.connect(self._on_fleet_changed)
        self._backend_keyvalidator.uav_changed.connect(self._on_uav_changed)
        self._backend_keyvalidator.frontend_connected.connect(self._on_frontend_connected)
        self._backend_keyvalidator.frontend_disconnected.connect(self._on_frontend_disconnected)
    ...
    def connect_frontend(self):
        """Frontend verbinden."""
        self._backend_keyvalidator.connect_frontend()
    
    def disconnect_frontend(self):
        """Frontend trennen."""
        self._backend_keyvalidator.disconnect_frontend()
    ...
    def get_fleet_data(self) -> Dict[str, Any]:
        ...
        Returns:
            Flottendaten
        """
        return self._backend_keyvalidator.get_fleet_data()
    ...
    def get_uav_data(self, uav_id: str) -> Dict[str, Any]:
        ...
        Returns:
            UAV-Daten
        """
        return self._backend_keyvalidator.get_uav_data(uav_id)
    ...
    def update_fleet_data(self, fleet_data: Dict[str, Any]):
        ...
        """
        self._backend_keyvalidator.update_fleet_data(fleet_data)
    ...
    def update_uav_data(self, uav_id: str, uav_data: Dict[str, Any]):
        ...
        Args:
            ...
            uav_data: UAV-Daten
        """
        self._backend_keyvalidator.update_uav_data(uav_id, uav_data)
