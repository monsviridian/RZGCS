"""Backend-KeyDecryptor.

Dieser KeyDecryptor implementiert die Verbindung zwischen Backend-KeyEncryptor und Backend-KeyManager.
"""
...
from flight_control.keymanager.backend_keymanager import BackendKeyManager

class BackendKeyDecryptor(QObject):
    """Backend-KeyDecryptor.
    
    Dieser KeyDecryptor implementiert die Verbindung zwischen Backend-KeyEncryptor und Backend-KeyManager.
    
    Attributes:
        _backend_keymanager: Backend-KeyManager
    ...
    def __init__(self):
        """Initialisierung."""
        super().__init__()
        self._backend_keymanager = BackendKeyManager()
        self._frontend_connected = False
        
        # Backend-KeyManager-Signale verbinden
        self._backend_keymanager.fleet_changed.connect(self._on_fleet_changed)
        self._backend_keymanager.uav_changed.connect(self._on_uav_changed)
        self._backend_keymanager.frontend_connected.connect(self._on_frontend_connected)
        self._backend_keymanager.frontend_disconnected.connect(self._on_frontend_disconnected)
    ...
    def connect_frontend(self):
        """Frontend verbinden."""
        self._backend_keymanager.connect_frontend()
    
    def disconnect_frontend(self):
        """Frontend trennen."""
        self._backend_keymanager.disconnect_frontend()
    ...
    def get_fleet_data(self) -> Dict[str, Any]:
        ...
        Returns:
            Flottendaten
        """
        return self._backend_keymanager.get_fleet_data()
    ...
    def get_uav_data(self, uav_id: str) -> Dict[str, Any]:
        ...
        Returns:
            UAV-Daten
        """
        return self._backend_keymanager.get_uav_data(uav_id)
    ...
    def update_fleet_data(self, fleet_data: Dict[str, Any]):
        ...
        """
        self._backend_keymanager.update_fleet_data(fleet_data)
    ...
    def update_uav_data(self, uav_id: str, uav_data: Dict[str, Any]):
        ...
        Args:
            ...
            uav_data: UAV-Daten
        """
        self._backend_keymanager.update_uav_data(uav_id, uav_data)
