...
Dieses Model implementiert die Verbindung zwischen Backend-Controller und Backend-Repository.
"""
...
from flight_control.repositories.backend_repository import BackendRepository
...
class BackendModel(QObject):
    ...
    Attributes:
        _backend_repository: Backend-Repository
    ...
    def __init__(self):
        """Initialisierung."""
        super().__init__()
        self._backend_repository = BackendRepository()
        self._frontend_connected = False
        
        # Backend-Repository-Signale verbinden
        self._backend_repository.fleet_changed.connect(self._on_fleet_changed)
        self._backend_repository.uav_changed.connect(self._on_uav_changed)
        self._backend_repository.frontend_connected.connect(self._on_frontend_connected)
        self._backend_repository.frontend_disconnected.connect(self._on_frontend_disconnected)
    ...
    def connect_frontend(self):
        """Frontend verbinden."""
        self._backend_repository.connect_frontend()
    
    def disconnect_frontend(self):
        """Frontend trennen."""
        self._backend_repository.disconnect_frontend()
    ...
    def get_fleet_data(self) -> Dict[str, Any]:
        ...
        Returns:
            Flottendaten
        """
        return self._backend_repository.get_fleet_data()
    ...
    def get_uav_data(self, uav_id: str) -> Dict[str, Any]:
        ...
        Returns:
            UAV-Daten
        """
        return self._backend_repository.get_uav_data(uav_id)
    ...
    def update_fleet_data(self, fleet_data: Dict[str, Any]):
        ...
        """
        self._backend_repository.update_fleet_data(fleet_data)
    ...
    def update_uav_data(self, uav_id: str, uav_data: Dict[str, Any]):
        ...
        Args:
            ...
            uav_data: UAV-Daten
        """
        self._backend_repository.update_uav_data(uav_id, uav_data)
