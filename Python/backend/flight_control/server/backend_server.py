...
Dieser Server implementiert die Verbindung zwischen Backend-API und Backend-Client.
"""
...
from flight_control.client.backend_client import BackendClient
...
class BackendServer(QObject):
    ...
    Attributes:
        _backend_client: Backend-Client
    ...
    def __init__(self):
        ...
        # Backend-Client-Signale verbinden
        self._backend_client.fleet_changed.connect(self._on_fleet_changed)
        self._backend_client.uav_changed.connect(self._on_uav_changed)
        self._backend_client.frontend_connected.connect(self._on_frontend_connected)
        self._backend_client.frontend_disconnected.connect(self._on_frontend_disconnected)
    ...
    def connect_frontend(self):
        """Frontend verbinden."""
        self._backend_client.connect_frontend()
    
    def disconnect_frontend(self):
        """Frontend trennen."""
        self._backend_client.disconnect_frontend()
    ...
    def get_fleet_data(self) -> Dict[str, Any]:
        ...
        Returns:
            Flottendaten
        """
        return self._backend_client.get_fleet_data()
    ...
    def get_uav_data(self, uav_id: str) -> Dict[str, Any]:
        ...
        Returns:
            UAV-Daten
        """
        return self._backend_client.get_uav_data(uav_id)
    ...
    def update_fleet_data(self, fleet_data: Dict[str, Any]):
        ...
        """
        self._backend_client.update_fleet_data(fleet_data)
    ...
    def update_uav_data(self, uav_id: str, uav_data: Dict[str, Any]):
        ...
        Args:
            ...
            uav_data: UAV-Daten
        """
        self._backend_client.update_uav_data(uav_id, uav_data)
