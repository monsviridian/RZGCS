...
class ConnectionViewModel(QObject):
    ...
    def __init__(self):
        ...
        # Verbinde Service-Signale
        self._service.status_changed.connect(self.status_changed)
        self._service.type_changed.connect(self.type_changed)
        self._service.parameters_changed.connect(self.parameters_changed)
        self._service.state_updated.connect(self.state_updated)
        self._service.statistics_updated.connect(self.statistics_updated)
        self._service.error_occurred.connect(self.error_occurred)
