"""
Kollisionsvermeidungs-ViewModel.
Implementiert die Präsentationslogik für Kollisionsvermeidungs-Operationen.
"""
...
class CollisionViewModel(QObject):
    """Implementiert die Präsentationslogik für Kollisionsvermeidungs-Operationen"""
    ...
    def __init__(self, service: Optional[CollisionService] = None):
        """
        Initialisiert das Kollisionsvermeidungs-ViewModel.
        
        Args:
            service: Optional: Kollisionsvermeidungs-Service
        """
        super().__init__()
    ...
    def set_service(self, service: CollisionService) -> None:
        """
        Setzt den Kollisionsvermeidungs-Service.
        
        Args:
            service: Kollisionsvermeidungs-Service
        """
        self._service = service
