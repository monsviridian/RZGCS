"""
Geofence-ViewModel.
Implementiert die Präsentationslogik für Geofencing-Operationen.
"""
...
class GeofenceViewModel(QObject):
    """Implementiert die Präsentationslogik für Geofencing-Operationen"""
    ...
    def __init__(self, service: Optional[GeofenceService] = None):
        """
        Initialisiert das Geofence-ViewModel.
        
        Args:
            service: Optional: Geofence-Service
        """
        super().__init__()
    ...
    def set_service(self, service: GeofenceService) -> None:
        """
        Setzt den Geofence-Service.
