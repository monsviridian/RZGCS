...
Diese API implementiert die Verbindung zwischen Backend-Database und Backend-Server.
"""
...
from flight_control.server.backend_server import BackendServer
...
class BackendAPI(QObject):
    ...
    Attributes:
        _backend_server: Backend-Server
    ...
    def __init__(self):
        ...
        # Backend-Server-Signale verbinden
        self._backend_server.fleet_changed.connect(self._on_fleet_changed)
        self._backend_server.uav_changed.connect(self._on_uav_changed)
        self._backend_server.frontend_connected.connect(self._on_frontend_connected)
        self._backend_server.frontend_disconnected.connect(self._on_frontend_disconnected)
    ...
    def connect_frontend(self):
        """Frontend verbinden."""
        self._backend_server.connect_frontend()
    
    def disconnect_frontend(self):
        """Frontend trennen."""
        self._backend_server.disconnect_frontend()
    ...
    def get_fleet_data(self) -> Dict[str, Any]:
        ...
        Returns:
            Flottendaten
        """
        return self._backend_server.get_fleet_data()
    ...
    def get_uav_data(self, uav_id: str) -> Dict[str, Any]:
        ...
        Returns:
            UAV-Daten
        """
        return self._backend_server.get_uav_data(uav_id)
    ...
    def update_fleet_data(self, fleet_data: Dict[str, Any]):
        ...
        """
        self._backend_server.update_fleet_data(fleet_data)
    ...
    def update_uav_data(self, uav_id: str, uav_data: Dict[str, Any]):
        ...
        Args:
            ...
            uav_data: UAV-Daten
        """
        self._backend_server.update_uav_data(uav_id, uav_data)
