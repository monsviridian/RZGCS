...
Diese Security implementiert die Verbindung zwischen Backend-Network und Backend-Encryption.
"""
...
from flight_control.encryption.backend_encryption import BackendEncryption

class BackendSecurity(QObject):
    """Backend-Security.
    
    Diese Security implementiert die Verbindung zwischen Backend-Network und Backend-Encryption.
    
    Attributes:
        _backend_encryption: Backend-Encryption
    ...
    def __init__(self):
        """Initialisierung."""
        super().__init__()
        self._backend_encryption = BackendEncryption()
        self._frontend_connected = False
        
        # Backend-Encryption-Signale verbinden
        self._backend_encryption.fleet_changed.connect(self._on_fleet_changed)
        self._backend_encryption.uav_changed.connect(self._on_uav_changed)
        self._backend_encryption.frontend_connected.connect(self._on_frontend_connected)
        self._backend_encryption.frontend_disconnected.connect(self._on_frontend_disconnected)
    ...
    def connect_frontend(self):
        """Frontend verbinden."""
        self._backend_encryption.connect_frontend()
    
    def disconnect_frontend(self):
        """Frontend trennen."""
        self._backend_encryption.disconnect_frontend()
    ...
    def get_fleet_data(self) -> Dict[str, Any]:
        ...
        Returns:
            Flottendaten
        """
        return self._backend_encryption.get_fleet_data()
    ...
    def get_uav_data(self, uav_id: str) -> Dict[str, Any]:
        ...
        Returns:
            UAV-Daten
        """
        return self._backend_encryption.get_uav_data(uav_id)
    ...
    def update_fleet_data(self, fleet_data: Dict[str, Any]):
        ...
        """
        self._backend_encryption.update_fleet_data(fleet_data)
    ...
    def update_uav_data(self, uav_id: str, uav_data: Dict[str, Any]):
        ...
        Args:
            ...
            uav_data: UAV-Daten
        """
        self._backend_encryption.update_uav_data(uav_id, uav_data)
