...
Diese Crypto implementiert die Verbindung zwischen Backend-Encryption und Backend-Key.
"""
...
from flight_control.key.backend_key import BackendKey

class BackendCrypto(QObject):
    """Backend-Crypto.
    
    Diese Crypto implementiert die Verbindung zwischen Backend-Encryption und Backend-Key.
    
    Attributes:
        _backend_key: Backend-Key
    ...
    def __init__(self):
        """Initialisierung."""
        super().__init__()
        self._backend_key = BackendKey()
        self._frontend_connected = False
        
        # Backend-Key-Signale verbinden
        self._backend_key.fleet_changed.connect(self._on_fleet_changed)
        self._backend_key.uav_changed.connect(self._on_uav_changed)
        self._backend_key.frontend_connected.connect(self._on_frontend_connected)
        self._backend_key.frontend_disconnected.connect(self._on_frontend_disconnected)
    ...
    def connect_frontend(self):
        """Frontend verbinden."""
        self._backend_key.connect_frontend()
    
    def disconnect_frontend(self):
        """Frontend trennen."""
        self._backend_key.disconnect_frontend()
    ...
    def get_fleet_data(self) -> Dict[str, Any]:
        ...
        Returns:
            Flottendaten
        """
        return self._backend_key.get_fleet_data()
    ...
    def get_uav_data(self, uav_id: str) -> Dict[str, Any]:
        ...
        Returns:
            UAV-Daten
        """
        return self._backend_key.get_uav_data(uav_id)
    ...
    def update_fleet_data(self, fleet_data: Dict[str, Any]):
        ...
        """
        self._backend_key.update_fleet_data(fleet_data)
    ...
    def update_uav_data(self, uav_id: str, uav_data: Dict[str, Any]):
        ...
        Args:
            ...
            uav_data: UAV-Daten
        """
        self._backend_key.update_uav_data(uav_id, uav_data)
