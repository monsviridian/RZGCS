...
Dieser Client implementiert die Verbindung zwischen Backend-Server und Backend-Protocol.
"""
...
from flight_control.protocol.backend_protocol import BackendProtocol
...
class BackendClient(QObject):
    ...
    Attributes:
        _backend_protocol: Backend-Protocol
    ...
    def __init__(self):
        """Initialisierung."""
        super().__init__()
        self._backend_protocol = BackendProtocol()
        self._frontend_connected = False
        
        # Backend-Protocol-Signale verbinden
        self._backend_protocol.fleet_changed.connect(self._on_fleet_changed)
        self._backend_protocol.uav_changed.connect(self._on_uav_changed)
        self._backend_protocol.frontend_connected.connect(self._on_frontend_connected)
        self._backend_protocol.frontend_disconnected.connect(self._on_frontend_disconnected)
    ...
    def connect_frontend(self):
        """Frontend verbinden."""
        self._backend_protocol.connect_frontend()
    
    def disconnect_frontend(self):
        """Frontend trennen."""
        self._backend_protocol.disconnect_frontend()
    ...
    def get_fleet_data(self) -> Dict[str, Any]:
        ...
        Returns:
            Flottendaten
        """
        return self._backend_protocol.get_fleet_data()
    ...
    def get_uav_data(self, uav_id: str) -> Dict[str, Any]:
        ...
        Returns:
            UAV-Daten
        """
        return self._backend_protocol.get_uav_data(uav_id)
    ...
    def update_fleet_data(self, fleet_data: Dict[str, Any]):
        ...
        """
        self._backend_protocol.update_fleet_data(fleet_data)
    ...
    def update_uav_data(self, uav_id: str, uav_data: Dict[str, Any]):
        ...
        Args:
            ...
            uav_data: UAV-Daten
        """
        self._backend_protocol.update_uav_data(uav_id, uav_data)
