    ...
    RowLayout {
        ...
        Button {
            ...
            background: Rectangle {
                color: parent.down ? "#40a040" : (parent.hovered ? "#50c050" : "#60d060")
                radius: 5
                border.color: "#ffffff"
                    }
                ...
                RowLayout {
                    ...
                    Button {
                        ...
                        font.bold: true
                        background: Rectangle {
                            color: parent.down ? "#a04040" : (parent.hovered ? "#c05050" : "#d06060")
                            radius: 5
                            border.color: "#ffffff"
                            border.width: 1
                        }
                    ...
                    Button {
                        ...
                        font.bold: true
                        background: Rectangle {
                            color: parent.down ? "#404080" : (parent.hovered ? "#5050a0" : "#6060c0")
                            radius: 5
                            border.color: "#ffffff"
                            border.width: 1
                        }
