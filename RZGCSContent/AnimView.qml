    ...
    View3D {
        ...
        PerspectiveCamera {
            ...
            SequentialAnimation {
                ...
                PauseAnimation { duration: 3000 } // Warten bis Drohne erscheint
                ParallelAnimation {
                    NumberAnimation {
                        target: camera
                        property: "position.y"
        ...
        Component {
            ...
            Model {
                ...
                function startParticleAnimation() {
                    ...
                    animX.duration = 1000 + Math.random() * 1000;
                    
                    animY.to = endPosition.y;
                    animY.duration = 1000 + Math.random() * 1000;
                    
                    animZ.to = endPosition.z;
                    animZ.duration = 1000 + Math.random() * 1000;
                ...
                Timer {
                    id: fadeOutTimer
                    interval: 2500  // Nach 2,5 Sekunden ausblenden (nach Positionierung)
                    running: false
                    onTriggered: {
