...
Diese Software wird unter einer proprietären Lizenz vertrieben. Alle Rechte vorbehalten.

Die Anwendung verwendet Komponenten unter verschiedenen Open-Source-Lizenzen:
- Qt Framework: LGPL v3
- PyMAVLink: LGPL v3
- Weitere Python-Bibliotheken: verschiedene Open-Source-Lizenzen

Detaillierte Lizenzinformationen finden Sie in den Dateien [LICENSE.md](LICENSE.md) und [THIRD_PARTY_LICENSES.md](THIRD_PARTY_LICENSES.md).